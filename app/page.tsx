  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-[#003B5C] text-white">
        ...
        <MathDeco latex="\displaystyle \sum_{\mathrm{sym}} x_1^{p_1} x_2^{p_2} \cdots x_n^{p_n} \geq \sum_{\mathrm{sym}} x_1^{q_1} x_2^{q_2} \cdots x_n^{q_n}$" className="top-1/3 left-[4%] text-[1.1rem]" />
        ...
        <MathDeco latex="E\left[\sum_{i=1}^n X_i\right] = \sum_{i=1}^n E[X_i]" className="top-1/2 right-[4%] text-[1.8rem]" />
