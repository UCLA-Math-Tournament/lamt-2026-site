  ...
  return (
    ...
    >
      <div className="relative mt-[10.5rem] flex w-fit flex-col items-center justify-center gap-5 text-center">
        <h1 className="relative z-10 font-[family-name:var(--font-headline)] text-7xl font-medium tracking-[-0.08em] lg:text-9xl">
          The Stroke <br /> That follows the <br />
          Scroll Progress
        </h1>
        <p className="relative z-10 max-w-2xl font-[family-name:var(--font-headline)] text-xl font-medium text-[#1F3A4B]">
      ...
      <div className="w-full translate-y-[200vh] rounded-[2rem] bg-[#1F3A4B] pb-10 font-[family-name:var(--font-headline)] text-[#FAFDEE]">
